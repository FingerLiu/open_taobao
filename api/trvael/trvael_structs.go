...
type TravelItemsProp struct {
	...
	Pid                   int    `json:"pid"`
	SortOrder             int    `json:"sort_order"`
	TravelItemsPropValues struct {
		TravelItemsPropValue []*TravelItemsPropValue `json:"travel_items_prop_value"`
	} `json:"travel_items_prop_values"`
}
